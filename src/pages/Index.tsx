...
// Type for scroll animation hook - Update this definition
type UseScrollAnimationReturn = [React.RefObject<HTMLDivElement>, boolean];

// Simple animation hook for scrolling into view
const useScrollAnimation = (): UseScrollAnimationReturn => {
  const [isVisible, setIsVisible] = useState<boolean>(false);
  // Make sure the ref is properly typed
  ...
  // Return the tuple exactly as defined in the type
...
const Index: React.FC = () => {
  ...
  return (
    <div
      className={`min-h-screen bg-gradient-to-b from-background to-slate-50 dark:from-gray-900 dark:to-gray-800 text-foreground dark:text-slate-100 font-body`}
    >
      {/* Navbar */}
      ...
      <section className="pt-32 pb-16 md:pt-40 md:pb-24">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-base md:text-lg text-muted-foreground mb-8 max-w-2xl mx-auto font-body">
            Review, comment, and approve PRs directly from Slack. Get insights
            into team performance and keep your development flowing without
            constant app switching.
          </p>
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link to="/register">
              <Button
                className="bg-gradient-to-r from-primary to-purple-600 hover:from-primary/90 hover:to-purple-600/90 font-display"
                size="lg"
              >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <Card className="p-5 shadow-md border-l-4 border-l-primary">
              ...
              <p className="text-sm text-muted-foreground">
                Stay in your workflow without jumping between apps
              </p>
            </Card>
            <Card className="p-5 shadow-md border-l-4 border-l-primary">
              <div className="font-semibold mb-1">Accelerate Review Cycles</div>
              <p className="text-sm text-muted-foreground">
                Make PR reviews a seamless part of team communication
              </p>
            </Card>
            <Card className="p-5 shadow-md border-l-4 border-l-primary">
              <div className="font-semibold mb-1">
              ...
              <p className="text-sm text-muted-foreground">
                Bring everyone into the conversation where it happens
              </p>
            </Card>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl md:text-4xl font-bold font-display">
              Solutions that transform your PR workflow
            </h2>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl md:text-4xl font-bold font-display mb-4">
              Track what matters to your team
            </h2>
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Gain visibility into metrics that directly impact your development
              velocity
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <Card className="p-6 shadow-md">
              ...
              <p className="text-muted-foreground text-sm">
                Track how quickly PRs receive their first review, a critical
                metric for maintaining developer flow.
              </p>
            </Card>
            ...
            <Card className="p-6 shadow-md">
              ...
              <p className="text-muted-foreground text-sm">
                Monitor the percentage of PRs that get merged vs. abandoned,
                indicating code quality and review effectiveness.
              </p>
            </Card>
            ...
            <Card className="p-6 shadow-md">
              ...
              <p className="text-muted-foreground text-sm">
                Measure PR creation, review, and merge rates over time to
                understand your team's development pace.
              </p>
            </Card>
            ...
            <Card className="p-6 shadow-md">
              ...
              <p className="text-muted-foreground text-sm">
                Visualize review patterns to identify knowledge silos and
                encourage better knowledge distribution.
              </p>
            </Card>
          </div>
        </div>
      ...
      <section
        ref={problemRef}
        className="py-16 md:py-24 bg-slate-50 dark:bg-slate-800/30"
      >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h2 className="text-3xl font-bold mb-4 font-display">
                Reclaim your developer flow state
              </h2>
              <p className="text-lg text-muted-foreground mb-6">
                Studies show developers lose up to 30 minutes of productive time
                each time they switch contexts. PingaPR eliminates this
                productivity drain by bringing GitHub workflows directly into
                Slack.
              </p>
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground text-sm">
                      Every time you switch between apps, it takes up to 23
                      minutes to regain complete focus. PingaPR keeps you in
                      your chat tool.
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground text-sm">
                      Teams using PingaPR complete reviews 32% faster and with
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground text-sm">
                      Keep technical discussions right where your team already
                      communicates, enhancing collaboration and transparency.
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <Card className="p-6 shadow-md border-t-4 border-t-cyan-500">
              ...
              <p className="text-muted-foreground mb-4">
                Development teams use PingaPR to keep their code review process
                flowing smoothly. By handling PR discussions directly in Slack,
                teams maintain momentum and avoid constant context switching
                between apps.
              </p>
              <div className="pt-2 border-t border-slate-200 dark:border-slate-700">
                ...
                <p className="text-xs text-muted-foreground mt-1">
                  Faster reviews, better focus, improved team communication
                </p>
              </div>
            </Card>
            ...
            <Card className="p-6 shadow-md border-t-4 border-t-purple-500">
              ...
              <p className="text-muted-foreground mb-4">
                Remote and distributed teams rely on PingaPR to keep everyone in
                sync. The dashboards provide visibility into team activity,
                while the Slack integration ensures no comments or requests fall
                through the cracks.
              </p>
              <div className="pt-2 border-t border-slate-200 dark:border-slate-700">
                ...
                <p className="text-xs text-muted-foreground mt-1">
                  Team visibility, improved coordination, seamless communication
                </p>
              </div>
            </Card>
            ...
            <Card className="p-6 shadow-md border-t-4 border-t-emerald-500">
              ...
              <p className="text-muted-foreground mb-4">
                Engineering managers and team leads use PingaPR's dashboards to
                get visibility into team performance. The standup dashboard
                helps run more focused daily meetings, while the analytics views
              ...
              <div className="pt-2 border-t border-slate-200 dark:border-slate-700">
                ...
                <p className="text-xs text-muted-foreground mt-1">
                  Effective standups, process insights, team productivity
                  oversight
                </p>
              </div>
            </Card>
          ...
          <div className="max-w-5xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
              <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md border border-slate-200 dark:border-slate-800 p-6 relative overflow-hidden">
                ...
                <div className="pl-2">
                  ...
                  <p className="text-muted-foreground mb-4 pl-11">
                    Create your PingaPR account. No credit card needed for the
                    trial period.
                  </p>
                  <div className="pl-11">
                    <Link to="/register">
              ...
              <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md border border-slate-200 dark:border-slate-800 p-6 relative overflow-hidden">
                ...
                <div className="pl-2">
                  <div className="flex items-center mb-4">
                    <div className="bg-blue-500 text-white h-8 w-8 rounded-full flex items-center justify-center mr-3">
                      2
                    </div>
                  ...
                  <p className="text-muted-foreground mb-4 pl-11">
                    Authorize our GitHub app with just a few clicks. We only
                    access PR metadata, not your code.
                  </p>
                  <div className="pl-11 flex items-center">
                    <Shield className="h-4 w-4 text-green-500 mr-2" />
                    <span className="text-xs text-green-600">
                      Only PR metadata, never your code
                    </span>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md border border-slate-200 dark:border-slate-800 p-6 relative overflow-hidden">
                ...
                <div className="pl-2">
                  <div className="flex items-center mb-4">
                    <div className="bg-[#4A154B] text-white h-8 w-8 rounded-full flex items-center justify-center mr-3">
                      3
                    </div>
                    <h3 className="text-xl font-bold font-display">
                      Add to Slack
                  ...
                  <p className="text-muted-foreground mb-4 pl-11">
                    Install our Slack app and link it to your GitHub
                    repositories with our guided setup.
                  </p>
                  <div className="pl-11 flex items-center">
              ...
              <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md border border-slate-200 dark:border-slate-800 p-6 relative overflow-hidden">
                ...
                <div className="pl-2">
                  <div className="flex items-center mb-4">
                    <div className="bg-green-500 text-white h-8 w-8 rounded-full flex items-center justify-center mr-3">
                      4
                    </div>
                    <h3 className="text-xl font-bold font-display">
                      Map Users & Go!
                  ...
                  <p className="text-muted-foreground mb-4 pl-11">
                    Connect GitHub users to Slack accounts, customize your
                    settings, and start improving your workflow.
                  </p>
                  <div className="pl-11 flex items-center">
          ...
          <div className="max-w-2xl mx-auto text-center">
            <div className="inline-block rounded-xl p-8 border border-slate-200 dark:border-slate-800">
              ...
              <p className="text-muted-foreground my-4">
                PingaPR never accesses your source code. We only access PR
                metadata like titles, reviewers, and statuses. All
                communications between our service and GitHub are securely
                encrypted.
              </p>
              <div className="flex flex-wrap justify-center gap-4 mt-6">
                <Badge className="bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-400 py-2">
      ...
      <section ref={pricingRef} className="py-16 md:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Perfect for teams of all sizes. Get started with our free tier and
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            {/* Free Tier */}
            <Card className="border-2 shadow-lg p-8 relative">
              ...
              <div className="space-y-4 mb-8">
                <div className="flex items-start gap-2">
                  ...
                  />
                  <div>
                    <p className="font-medium">Up to 50 PRs per month</p>
                    <p className="text-sm text-muted-foreground">
                ...
                <div className="flex items-start gap-2">
                  ...
                  />
                  <div>
                    <p className="font-medium">Up to 5 team members</p>
                    <p className="text-sm text-muted-foreground">
                ...
                <div className="flex items-start gap-2">
                  ...
                  />
                  <div>
                    <p className="font-medium">GitHub & Slack Integration</p>
                    <p className="text-sm text-muted-foreground">
                ...
                <div className="flex items-start gap-2">
                  ...
                  />
                  <div>
                    <p className="font-medium">Basic Dashboard</p>
                    <p className="text-sm text-muted-foreground">
                      Essential PR tracking and metrics
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-2">
                  ...
                  />
                  <div>
                    <p className="font-medium">Smart PR Alerts</p>
                    <p className="text-sm text-muted-foreground">
                      Configurable stale PR reminders (24hr default)
                    </p>
                  </div>
                </div>
              </div>
            ...
            {/* Professional Tier */}
            <Card className="border-2 border-primary shadow-xl p-8 relative bg-gradient-to-b from-primary/5 to-transparent">
              ...
              <div className="space-y-4 mb-8">
                <div className="flex items-start gap-2">
                  ...
                  />
                  <div>
                    <p className="font-medium">Unlimited PRs</p>
                    <p className="text-sm text-muted-foreground">
                      No monthly limits on PR processing
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-2">
                ...
                <div className="flex items-start gap-2">
                  ...
                  />
                  <div>
                    <p className="font-medium">Team Collaboration Dashboard</p>
                    <p className="text-sm text-muted-foreground">
                      Understand team dynamics and patterns
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-2">
                  ...
                  />
                  <div>
                    <p className="font-medium">Standup Dashboard</p>
                    <p className="text-sm text-muted-foreground">
                      Streamline daily standups with PR insights
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-2">
                  ...
                  />
                  <div>
                    <p className="font-medium">Custom Teams & Filtering</p>
                    <p className="text-sm text-muted-foreground">
                      Organize teams and filter dashboards
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-2">
                  ...
                  />
                  <div>
                    <p className="font-medium">Advanced PR Alerts</p>
                    <p className="text-sm text-muted-foreground">
                      Customizable stale PR notifications & reminders
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="bg-gradient-to-r from-primary to-purple-600 text-white rounded-2xl p-10 md:p-14 shadow-xl overflow-hidden relative">
            <div className="max-w-3xl mx-auto text-center relative z-10">
              ...
              <p className="text-xl mb-8 opacity-90">
                Join our early access program and experience how PingaPR can
              ...
              <p className="mt-4 text-sm opacity-80">
                14-day free trial • No credit card required • Your code stays
                private
              </p>
            </div>
            {/* Background elements */}
          ...
          <div className="space-y-4">
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md border border-slate-200 dark:border-slate-800 overflow-hidden">
              <details className="group">
                <summary className="flex justify-between items-center font-medium cursor-pointer p-6">
                  <h3 className="text-xl font-bold">
                    Can PingaPR access my source code?
                  </h3>
                ...
                <div className="p-6 pt-0 text-muted-foreground">
                  <p>
                    Absolutely not. PingaPR only accesses PR metadata like
                    titles, reviewers, and statuses. We never access, store, or
                    process your source code. Your intellectual property remains
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md border border-slate-200 dark:border-slate-800 overflow-hidden">
              <details className="group">
                ...
                <div className="p-6 pt-0 text-muted-foreground">
                  <p>
                    Our guided 4-step onboarding process typically takes less
                    than 15 minutes. We walk you through GitHub and Slack
                    authorization, repository selection, user mapping, and
                    configuration with a simple, intuitive interface. Most teams
                    are fully operational within an hour of signing up.
                  </p>
                </div>
              </details>
            </div>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md border border-slate-200 dark:border-slate-800 overflow-hidden">
              <details className="group">
                ...
                <div className="p-6 pt-0 text-muted-foreground">
                  <p>
                    We currently offer deep integration with GitHub and Slack.
                    Microsoft Teams integration is on our roadmap for Q3 2025.
                    We're also exploring integrations with JIRA, Linear, and
                    other project management tools based on customer feedback.
                    If there's a specific integration you need, please let us
                    know!
                  </p>
                </div>
              </details>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md border border-slate-200 dark:border-slate-800 overflow-hidden">
              <details className="group">
                <summary className="flex justify-between items-center font-medium cursor-pointer p-6">
                  <h3 className="text-xl font-bold">
                    What makes your dashboards special?
                  </h3>
                  <span className="transition group-open:rotate-180">
                    <svg
                      fill="none"
                ...
                <div className="p-6 pt-0 text-muted-foreground">
                  <p>
                    Unlike generic project management tools, our dashboards are
                    purpose-built for developer workflows. The Standup Dashboard
                    streamlines daily meetings with actionable PR status and
                    discussion points. The Analytics Dashboard provides insights
                    into team velocity and review patterns. The Collaboration
                    Dashboard visualizes knowledge sharing across your team.
                    Each view is designed to solve specific pain points in the
                    development process.
                  </p>
                </div>
              </details>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md border border-slate-200 dark:border-slate-800 overflow-hidden">
              <details className="group">
                <summary className="flex justify-between items-center font-medium cursor-pointer p-6">
                  <h3 className="text-xl font-bold">
                    How does team organization work?
                  </h3>
                  <span className="transition group-open:rotate-180">
                    <svg
                      fill="none"
                ...
                <div className="p-6 pt-0 text-muted-foreground">
                  <p>
                    PingaPR allows you to create custom teams that can be used
                    to filter dashboard views. This is particularly useful for
                    larger organizations with multiple teams working across
                    different repositories. You can organize teams by project,
                    function, or any other structure that makes sense for your
                    workflow. Each team gets their own filtered views of PR
                    activity, making it easier to focus on what matters to them.
                  </p>
                </div>
              </details>
            </div>
      ...
      <footer className="py-12 border-t border-slate-200 dark:border-slate-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            ...
            {/* This empty div creates space between the logo and the links */}
            <div className="md:col-span-2"></div>

            {/* Privacy/Terms links now on the right */}
